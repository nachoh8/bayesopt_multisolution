/**  \file posterior_model.hpp \brief Abstract interface for posterior model/criteria */
/*
-------------------------------------------------------------------------
...
namespace bayesopt {
 ...
 /**
  ...
  // TODO (Javier): Implemented in cpp
  /*inline vectord PosteriorModel::getPointAtMinimum(bool useMean = false)
  ...
  inline double PosteriorModel::getPredictionMean(const vectord& query)
  {
    return getPrediction(query)->mean();
  }
