...
namespace bayesopt {
  ...
  /** Abstract functor for (R) real-valued, (B) bounded functions to
      be optimized */
  class RBOptimizable
  {
  public:
  ...
  /** Abstract functor for (R) real-valued, (G) gradient-based, (B)
      bounded functions to be optimized */
  ...
  /// Wrapper for polimorphyc instances of RBOptimizable
  ...
  /// Wrapper for polimorphyc instances of RGBOptimizable
