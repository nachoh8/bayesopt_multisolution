...
#include "means/mean_functors.hpp"
...
namespace bayesopt
{
  ...
  public:
    ...
    virtual JointDistribution* pointsPrediction(const vecOfvec &points){
      throw std::runtime_error("Function \"pointsPrediction\" is not implemented for this type");
    }
    ...
    double getIntegratedOutcome(const vectord& query);
  ...
  inline double NonParametricProcess::getNoise() 
  { return mNoise; };
