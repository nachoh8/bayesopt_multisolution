...
namespace bayesopt
{
  ...
  public:
    ...
    virtual void addSample(double y);
    ...
    double getValueAtMaximum() const;
  ...
  inline void Dataset::addSample(double y)
  {
    utils::append(mY,y);
    updateMinMax(mY.size()-1);
  }
  ...
  inline double Dataset::getValueAtMaximum() const { return mY(mMaxIndex); };
