...
if (ispc)
    if exist('../bin/Release/bayesopt.dll','file')
        ...
        mex -DBAYESOPT_DLL -output bayesoptcont bayesoptmex.c ...
            ...
            -I..\include\api -I..\wrappers
        mex -DBAYESOPT_DLL -output bayesoptlog bayesoptlog.c ...
            -L..\lib\Release -L. -lbayesopt ...
            -I..\include\api -I..\wrappers
        ...
        mex -output bayesoptlog bayesoptlog.c  ...
            -L../lib/Release -lbayesopt -lnlopt ...
            -I../include/api -I../wrappers
    ...
    mex -output bayesoptcont bayesoptmex.c -L../lib -lbayesopt ...
        -lnlopt -I../include/api -I../wrappers -I../nlopt/api 

    mex -output bayesoptlog bayesoptlog.c -L../lib -lbayesopt ...
        -lnlopt -I../include/api -I../wrappers -I../nlopt/api 
