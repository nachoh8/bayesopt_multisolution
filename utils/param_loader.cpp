...
namespace bayesopt
{
  namespace utils{
    ...
    void ParamLoader::loadOrSave(utils::FileParser &fp, Parameters &par){
        ...
        fp.readOrWrite("n_final_samples", par.n_final_samples);
        fp.readOrWrite("n_iter_relearn", par.n_iter_relearn);
        fp.readOrWrite("n_parallel_samples", par.n_parallel_samples);
        fp.readOrWrite("burnout_mcmc_parallel", par.burnout_mcmc_parallel);
        ...
        fp.readOrWrite("unscented_alpha", par.unscented_alpha);
        fp.readOrWrite("unscented_beta", par.unscented_beta);
        fp.readOrWrite("unscented_kappa", par.unscented_kappa);
        fp.readOrWrite("input_noise_variance", par.input_noise_variance);
        fp.readOrWrite("use_unscented_criterion", par.use_unscented_criterion);
