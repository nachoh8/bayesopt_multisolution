...
int main(int nargs, char *args[])
{
  ...
  for(size_t repetition = init_rep; repetition < init_rep+n_simulations; repetition++)
  {
    ...
    par.n_crit_params = 4;
    par.crit_params[0] = 20; // ES mNumCandidates
    par.crit_params[1] = 500; // ES mNumGPSamples
    par.crit_params[2] = 10; // ES mNumSamplesY
    par.crit_params[3] = 100; // ES mNumTrialPoints
