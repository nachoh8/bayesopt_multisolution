...
int main()
{
    ...
    int saved_samples = 2; // this parameters can be modified to check other cases

    std::cout << "Testing with saved_samples=" << saved_samples << std::endl;
    ...
    state1.mY.resize(saved_samples); // save only first samples
    state1.mX.resize(params.n_init_samples); // save only initial samples
